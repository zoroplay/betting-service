...
export class BetsController {
  ...
  placeCasinoBet(data: PlaceCasinoBet): Promise<PlaceBetResponse> {
    return this.betsService.placeCasinoBet(data);
  }

  // Settle Casino Bet
  @GrpcMethod('BettingService', 'settleCasinoBet')
  settleCasinoBet(data: CreditCasinoBet): Promise<PlaceBetResponse> {
    return this.betsService.settleCasinoBet(data);
  }

  // Cancel Casino Bet
  @GrpcMethod('BettingService', 'cancelCasinoBet')
  cancelCasinoBet(data: RollbackCasinoBet): Promise<PlaceBetResponse> {
    return this.betsService.cancelCasinoBet(data);
  }
}
